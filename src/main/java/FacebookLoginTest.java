...
public class FacebookLoginTest {
    ...
    public void testFacebookLogin() {
        ...
        //Accept cookies
        try {
            WebElement acceptAllCookiesBtn = new WebDriverWait(driver, Duration.ofSeconds(10)).until(ExpectedConditions.elementToBeClickable(By.xpath("//button"+"[contains(., 'Allow')]"))); acceptAllCookiesBtn.click();
        } catch (Exception e) {
        ...
        //Verify login
        //driver.findElement(By.linkText(" Find your account and log id."));
